...
public class NoteService {
	...
	public Note save(final Note note) {
		...
		b.setAuthority(Authority.REFEREE);
		c.setAuthority(Authority.HANDYWORKER);
		Assert.isTrue(user.getAuthorities().contains(a) || user.getAuthorities().contains(b) || user.getAuthorities().contains(c));
	...
	public Collection<Note> findByRefereeId(final Integer integer) {
		return this.noteRepository.findByRefereeId(integer);
	}
}
